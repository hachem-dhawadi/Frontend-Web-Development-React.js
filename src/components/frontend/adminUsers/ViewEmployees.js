...
function ViewEmployees() {
    ...
    useEffect(() => {
        ...
        axios.get(`/api/alljobsbyowner`).then(res => {
            if (res.data.status === 200) {
                setUser(res.data.jobs);
                setLoading(false);
                    ...
                    <div class="contact-directory-box">
                        <div class="contact-dire-info text-center">
                            <div class="contact-avatar">
                                <img src={`http://localhost:8000/${item.user.image}`} width={250} height={250} />
                            </div>
                            <br></br>
                            <div class="contact-name">
                                <h5>{item.user.name}</h5>
                                <p>Email : {item.user.email}</p>
                                <p>Cin : {item.user.cin}</p>
                        ...
                        <div class="view-contact">
                            <Link onClick={() => swal({
                                    title: "Are you sure?",
                                    text: "You wanna fire this Employee",
                                    icon: "warning",
                                    buttons: true,
                                    dangerMode: true,
                                })
                        ...
                        <div className="col-md-6 col-sm-12">
                            ...
                            <nav aria-label="breadcrumb" role="navigation">
                                <ol className="breadcrumb">
                                    ...
                                    <li className="breadcrumb-item active" aria-current="page">List of Employees</li>
                                </ol>
                            </nav>
                        </div>
