...
function AddRoom(props) {
    ...
    const [UserId, setUserId] = useState();//categorylist
    ...
    useEffect(() => {
        ...
        axios.get(`/api/edit-room/${id}`).then(res => {
            if (res.data.status === 200) {
                console.log("user_id");
                setUserId(res.data.room.user_id);
                setRoom(res.data.room);
                setCheckboxes(res.data.room);
            }
    ...
    const updateRoom = (e) => {
        ...
        axios.get('/sanctum/csrf-cookie').then(response => {
            axios.post(`/api/update-room/${id}`, formData, {
                headers: {
                                ...
                                <div className="col-md-6 col-sm-12">
                                    ...
                                    <nav aria-label="breadcrumb" role="navigation">
                                        <ol className="breadcrumb">
                                            ...
                                            <li className="breadcrumb-item active" aria-current="page">Edit queue</li>
                                        </ol>
                                    </nav>
                                </div>
                        ...
                        <div className="pd-20 card-box mb-30">
                            <div className="clearfix">
                                <div className="pull-left">
                                    <h4 className="text-blue h4">Edit Queue</h4>
                                </div>
                            </div>
                            <form onSubmit={updateRoom}>
                                ...
                                <div className="form-group">
                                    ...
                                    <img src={`http://localhost:8000/${roomInput.image}`} width={70} height={70}/>
