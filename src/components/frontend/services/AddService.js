...
function AddService() {
    ...
    useEffect(() => {
        ...
        axios.get(`/api/alladminusers`).then(res => {
            if (res.data.status === 200) {
    ...
    const submitService = (e) => {
        ...
        formData.append('start', serviceInput.start);
        ...
        axios.get('/sanctum/csrf-cookie').then(response => {
            axios.post(`/api/store-service`, formData, {
                headers: {
                        ...
                        <div className="pd-20 card-box mb-30">
                            <div className="clearfix">
                                <div className="pull-left">
                                    <h4 className="text-blue h4">Add new Service</h4>
                                </div>
                            </div>
                            <form onSubmit={submitService}>
                                ...
                                <p class="text-danger">{errorlist.category_id}</p>

                                <div class="form-group row">
                                    <label class="col-sm-12 col-md-2 col-form-label">Select User to the service</label>
                                    <div class="col-sm-12 col-md-10">
                                ...
                                <p class="text-danger">{errorlist.user_id}</p>


                                <div class="form-group row">
                                    <label class="col-sm-12 col-md-2 col-form-label">Select Location to  service</label>
                                    <div class="col-sm-12 col-md-10">
                                        <select name="location" className="custom-select col-12" title="Select role" onChange={handleLocationChange}>
                                ...
                                <p class="text-danger">{errorlist.location}</p>
