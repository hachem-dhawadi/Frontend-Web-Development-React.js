        ...
        dispaly_Categorydata = filteredcategory.map((item) => {
            ...
            return (
                <tr key={item.id}>
                    ...
                    <td>
                    {/* <Link to={`/ServicesLogin/${item.id}`} className="dropdown-item" ><i className="dw dw-eye" /> View</Link> */}

                    {item.active === 1 ? (
                            <Link to={`/ServicesLogin/${item.id}`} className="dropdown-item">
                ...
                <div className="pd-ltr-20">
                    ...
                    <div className="clearfix">
                            <div className="h4 pd-20">
                                <h4 className="text-blue h4">List of Categories</h4>
                            </div>
                        </div>
