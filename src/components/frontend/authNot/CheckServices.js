...
function CheckServices() {
    ...
    const filteredcategory = ServiceList.filter((cat) =>
            ...
            return (
                <tr key={item.id}>
                    ...
                    <td>
                        ...
                        {/* <Link className="dropdown-item" to={`/CheckRooms/${item.category.id}/${item.id}`} ><i className="dw dw-eye" /> View</Link> */}
                        {item.active === 1 ? (
                            <Link to={`/CheckRooms/${item.category.id}/${item.id}`}className="dropdown-item">
            ...
            <div className="login-wrap d-flex align-items-center flex-wrap justify-content-center">
                <div className="container">
                    <div className="card-box mb-30">
                        <br></br>
                        <h2 className="text-blue h3">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; Services List</h2>
                        <form>
