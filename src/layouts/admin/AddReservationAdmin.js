...
function AddReservationAdmin() {
    ...
    const SetTiming = (e) => {
        ...
        axios.get('/sanctum/csrf-cookie').then((response) => {
            axios.post(`/api/SetTiming/${roomId}`, formData, {
                headers: {
    ...
    const SetTimingDecrement = (e) => {
        e.preventDefault();
        const formData = new FormData();
        console.log(TimeInput.time);
        formData.append('time', TimeInput.time);
        axios.get('/sanctum/csrf-cookie').then((response) => {
            axios.post(`/api/SetTimingDecrement/${roomId}`, formData, {
                headers: {
                    'Content-Type': 'multipart/form-data',
                },
            }).then((res) => {
    ...
    const submitService = (e) => {
        const repetition = serviceInput.Newrepetition; // Number of times to repeat
        ...
        for (let i = 0; i < repetition; i++) {
            ...
            // Calculate the new date value based on the repetition index
    ...
    const ResetReservation = (id) => {
        axios.post(`/api/ResetReservationAdmin/${id}`)
            .then((res) => {
                if (res.data.status === 200) {
                    // Reset successful
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div className="form-group">
                                        <button type="button" onClick={(e) => SetTiming(e)} class="btn btn-primary">Increment timing++</button> &nbsp;&nbsp;
                                        <button type="button" onClick={(e) => SetTimingDecrement(e)} class="btn btn-primary">Decrement timing--</button>
                                        </div>
...
export default AddReservationAdmin;